...
#PBS -o preprocess_sw_15.out
#PBS -e preprocess_sw_15.err
...
for dataset_name in ${DATASETS}; do
    ...
    output_prefix_dir="${BASE_DIR}/preprocessed/${dataset_name}/pubmed_150000-1024"
    output_prefix="${output_prefix_dir}/${dataset_name}"
    wandb_name="${DATE_TAG}-miyabi-${dataset_name}-150000-1024"
