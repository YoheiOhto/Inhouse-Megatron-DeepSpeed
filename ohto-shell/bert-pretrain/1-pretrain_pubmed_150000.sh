...
#PBS -o med_150000_pub.out
#PBS -e med_150000_pub.err
...
jobname="med-bert-full-150000-pub-mask30"
...
lr_decay_iters=44710 # これが lr_decay_steps に対応
...
# BLEND DATASET
pubmed_path="/work/gg17/a97006/250519_modern_bert_0/preprocessed/pubmed/pubmed_150000-1024/pubmed_text_sentence"
pmc_path="/work/gg17/a97006/250519_modern_bert_0/preprocessed/pmc/pubmed_150000-1024/pmc_text_sentence"
fda_label_path="/work/gg17/a97006/250519_modern_bert_0/preprocessed/fda_label/pubmed_150000-1024/fda_label_text_sentence"
nih_books_path="/work/gg17/a97006/250519_modern_bert_0/preprocessed/nih_books/pubmed_150000-1024/nih_books_text_sentence"

# fda: 4,881,170 samples
weight_fda=0.0368
# nih: 1,761,120 samples
weight_nih=0.0133
# pubmed: 22,897,004 samples
weight_pubmed=0.1727
# pmc: 103,023,949 samples
weight_pmc=0.7772
...
megatron_options=" \
    ...
    --wandb-exp-name full-med-1-epoch-150000-pub \
