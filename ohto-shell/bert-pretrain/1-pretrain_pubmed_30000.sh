...
#PBS -o med_30000_pub.out
#PBS -e med_30000_pub.err
...
jobname="med-bert-full-30000-pub-2-mask30"
...
lr_decay_iters=45150 # これが lr_decay_steps に対応
...
weight_fda_label=0.0384
# nih_books: 5,163,951 samples
weight_nih_books=0.0141
...
megatron_options=" \
    ...
    --wandb-exp-name full-med-1-epoch-test-pub \
